...
import com.zms.zpc.emulator.board.pci.PCSpeaker;
 ...
 * Copyright 2002-2016
 */
public class IntervalTimer extends BaseIODevice {
     ...
     */
    public IntervalTimer(MotherBoard mb, int ioPort, int irq) {
        this.mb = mb;
        this.irq = irq;
        ioPortBase = ioPort;
    ...
    protected void init() {
        ...
        this.irqDevice = mb.pic;
        this.timingSource = mb.vc;
        if (channels == null) {
    ...
    public class TimerChannel implements TimerResponsive {
